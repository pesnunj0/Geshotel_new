...
Namespace geshotelk
    Partial Public Class GesHotelClase
        ...
        Private Function CheckinOnlineObitneReserva(cmd As MysqlCommand, bono As String, fecha As Date, Optional reserva_id As Integer = 0)
            Dim reserva As DataSet = Nothing
            Try
                cmd.Parameters.Clear()
                Dim fecha_llegadaParam As New MysqlParameter("@fecha_llegada", fecha)
                Dim bonoParam As New MysqlParameter("@bono", bono)
                Dim reserva_idParam As New MysqlParameter("@reserva_id", reserva_id)
                Dim reserva_id1Param As New MysqlParameter("@reserva_id1", reserva_id)
                ...
                Try
                    ...
                    If reserva.Tables(0).Rows.Count > 0 Then
                        ...
                        If reserva.Tables(0).Rows(0).Item("checkin_on_line") = 1 Then
                            ...
                            cmd.Parameters.Clear()
                            Dim reserva_idParam As New MysqlParameter("@reserva_id", reserva.Tables(0).Rows(0).Item("reserva_id"))
                            cmd.Parameters.Add(reserva_idParam)
                            ...
                            Dim fecha_llegadaParam As New MysqlParameter("@fecha_llegada", fecha_llegada)
                            ...
                            Dim desc_cortaParam As New MysqlParameter("@desc_corta", desc_corta)
                            cmd.Parameters.Add(fecha_llegadaParam)
                            cmd.Parameters.Add(hotel_idParam)
        ...
        Private Function actualizaEmailReserva(reserva_id As Integer, email As Object, olleg As Object, languaje As Object, hora_llegada As Object) As Integer
            ...
            End Try
            Dim emailParam As New MysqlParameter("@email", email)
            Dim ollegParam As New MysqlParameter("@olleg", olleg)
            Dim idioma_idParam As New MysqlParameter("@idioma_id", languaje)
            Dim hora_llegadaaram As New MysqlParameter("@hora_llegada", hora_llegada)
            Dim reserva_idParam As New MysqlParameter("@reserva_id", reserva_id)
...
& " items_limpieza"
        ...
        Public Function setLimpiezas(usuario As String, password As String, Optional ip As String = "80.59.112.27", Optional register As String = Nothing, Optional tiporegister As String = Nothing, Optional language As String = Nothing, Optional repasada As Integer = -1, Optional habitacion As String = Nothing) As String
            ...
            If Not IsNothing(logged) Then
                ...
                If Not IsDBNull(login.userId) Then
                    ...
                    Dim cmd As MysqlCommand = prepareConection()
                    cmd.Parameters.Clear()
                    Dim usuario_idParam As New MysqlParameter("@usuario_id", usuario_id)
                        ...
                        If Not IsDBNull(hotel_id) Then
                            ...
                            Try
                                ...
                                If habitacion_id > 0 Then
                                    ...
                                    cmd.Parameters.Clear()
                                    Dim habitacion_idParam As New MysqlParameter("@hotel_id", habitacion_id)
        ...
        Public Function getNotificaciones(register As String, tiporegister As String, languaje As String)
            ...
            Try
                ...
                cmd.Parameters.Clear()
                Dim registerParam As New MysqlParameter("@register", register)
                cmd.Parameters.Add(registerParam)
                Dim tipoParam As New MysqlParameter("@tipo", tipo)
            ...
            If Not IsNothing(logged) Then
                ...
                If Not IsDBNull(login.userId) Then
                    ...
                    Try
                        ...
                        Dim user_idParam As New MysqlParameter("@user_id", login.userId)
                        ...
                        If Not IsDBNull(departamento_id) Then
                            ...
                            Dim departamento_idParam As New MysqlParameter("@departamento_id", departamento_id)
                            cmd.Parameters.Clear()
                    ...
                    If Not IsDBNull(hotel_id) Then
                        ...
                        Try
                            ...
                            If Not IsNothing(reserva) Then
                                ...
                                Dim fechaParamn As New MysqlParameter("@fecha", convertFecha(Today))
                                cmd.Parameters.Clear()
                                cmd.Parameters.Add(usuario_idParam)
        ...
        Public Function getGaleria(hotel_id As Integer) As String
            ...
            cmd.Parameters.Clear()
            Dim hotel_idParam As New MysqlParameter("@hotel_id", hotel_id)
            Dim hotel_id1Param As New MysqlParameter("@hotel_id", hotel_id)
            cmd.Parameters.Add(hotel_idParam)
        ...
        Public Function setGaleria(datos As String) As String
            ...
            Dim hotel_id1Param As New MysqlParameter("@hotel_id", 0)
            cmd.Parameters.Add(hotel_idParam)
            cmd.Parameters.Add(hotel_id1Param)
            Try
                ...
                For x = 0 To fotos.Rows.Count - 1
                    ...
                    If Not esbaja Then
                        ...
                        If Not IsNothing(lenguajes) Then
                            cmd.Parameters.Clear()
                            Dim lan_codeParam As New MysqlParameter("@lan_code", -1)
                    ...
                    Else
                        ...
                        'clave GALERIA_1
                        cmd.Parameters.Clear()
                        Dim galeria_idNombreParam As New MysqlParameter("@galeria_id", "GALERIA_NOMBRE_" & galeria_id)
                        Dim galeria_idDescripcionParam As New MysqlParameter("@galeria_id", "GALERIA_DESC_" & galeria_id)
        ...
        Public Function setLanguage(cmd As MysqlCommand, languages As DataSet) As Integer
            Dim resultado As String = "no:" ' + lanurl 'un valor por defecto con error
            Dim errorCode As Integer = 0
            Try
        ...
        Public Function getLanguage(lanurl As String) As String
            ...
            If lanurl.Length = 2 Then
                ...
                Try
                    cmd.Parameters.Clear()
                    Dim lan_codeParam As New MysqlParameter("@lan_code", lanurl)
                    cmd.Parameters.Add(lan_codeParam)
            ...
            If Not IsNothing(reserva) Then
                Try
                    ...
                    If Not IsNothing(hotel_id) Then
                        cmd.Parameters.Clear()
                        Dim hotel_idParam As New MysqlParameter("@hote_id", hotel_id)
                        cmd.Parameters.Add(hotel_idParam)
                    ...
                    If reserva.Tables(0).Rows.Count > 0 Then
                        ...
                        cmd.Parameters.Clear()
                        Dim fecha_prevista_llegadaParam As New MysqlParameter("@fecha_prevista_llegada", reserva.Tables(0).Rows(0).Item("fecha_prevista_llegada"))
                        Dim fecha_prevista_salidaParam As New MysqlParameter("@fecha_prevista_salida", reserva.Tables(0).Rows(0).Item("fecha_prevista_salida"))
...
& "  <ACTION VERSION='' STATUS='" & errornum & "' ACTION='error' DATA='" & func & "'/>"
                ...
                If reserva.Tables(0).Rows.Count > 0 Then
                    ...
                    If Not dr.IsNull("email") Then
                        ...
                        If soloonline And idioma_id <> "" OrElse Not soloonline Then
                            ...
                            cmd.Parameters.Clear()
                            Dim idioma_idParam As New MysqlParameter("@idioma_id", idioma_id)
                            Dim idioma_id1Param As New MysqlParameter("@idioma_id1", idioma_id)
                            Dim tipoParam As New MysqlParameter("@tipo", tipo)
                            cmd.Parameters.Add(idioma_idParam)
        ...
        Private Function obtieneTipoRegister(tiporegister As String)
            ...
            Return tipo
        End Function
        Private Function registraDispositivoHDHotels(cmd As MysqlCommand, register As String, tiporegister As String, hotel_id As Integer, reserva_id As Integer, language As String, Optional usuario_id As Integer = Nothing) As Boolean
        ...
        Private Function getEncuesta(hotel_id As String, habitacion As String, razon As String) As String
            ...
            Try
                cmd.Parameters.Clear()
                Dim lan_codeParam As New MysqlParameter("@hotel_id", hotel_id)
                cmd.Parameters.Add(lan_codeParam)
        ...
        Private Function setEncuesta(cmd As MysqlCommand, hotel_id As String, habitacion As String, razon As String, encuesta As DataSet) As Integer
            'validar datos
            'getEncuesta()
            'no existe la creo
            'existe la actualizo
            ...
            If Not IsNothing(apellido) And Not IsNothing(habitacion) And Not IsNothing(fecha_llegada) Then
                ...
                If IsNumeric(habitacion) And IsDate(fecha_llegada) And apellido.Length > 2 Then
                    ...
                    Try
                        ...
                        Dim fecha_llegadaParam As New MysqlParameter("@fecha_llegada", fecha_llegada)
                        cmd.Parameters.Add(fecha_llegadaParam)
                        Dim numhabParam As New MysqlParameter("@numhab", numhab)
                        cmd.Parameters.Add(numhabParam)
                        Dim apellidoParam As New MysqlParameter("@apellido", apellido)
