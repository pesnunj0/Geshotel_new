 ...
 *********************************************************************************** 
 * Modificación 07/01/2017 Por Javier Nuñez
 * Loco de la cabeza me volví hasta quedescubrí el motivo
 * Caso siniestro de bug con Chrome 
 * Modificado createCssRules() y añadidos addCssRule
 ***********************************************************************************
 */
...
(function ($) {
    ...
    function SlickGrid(container, data, columns, options) {
        ...
        // ***************************
        // Añadido por Javier Nuñez
        // Enero 2017
        // Me volvió gilipollas 2 días
        // ***************************
        function createCssRules() {
            ...
            var index = 0;
            addCSSRule(sheet, "." + uid + " .slick-group-header-column", xLeft + ": 1000px;", index++);
