...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (CajasRow) {
            ...
            ['CajaId', 'HotelId', 'NombreCaja', 'DescCorta', 'CierreDia', 'CtaContable', 'DptoContable', 'UserId', 'FechaModificacion', 'HotelName', 'EmpresaId', 'Empresa', 'UserName'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (CajasService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                CajasService[x] = function (r, s, o) { return Q.serviceRequest(CajasService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (CanalesReservaRow) {
            ...
            ['CanalReservaId', 'EmpresaId', 'NombreCanal', 'Empresa'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (CanalesReservaService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                CanalesReservaService[x] = function (r, s, o) { return Q.serviceRequest(CanalesReservaService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        [['EmpresaId', function () { return Serenity.IntegerEditor; }], ['SerieId', function () { return Serenity.IntegerEditor; }], ['Ano', function () { return Serenity.IntegerEditor; }], ['Contador', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(ContadoresForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Contratos = Geshotel.Contratos || (Geshotel.Contratos = {}));
})(Geshotel || (Geshotel = {}));
var Geshotel;
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (ContadoresRow) {
            ...
            ['ContadorId', 'EmpresaId', 'SerieId', 'Ano', 'Contador'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (ContadoresService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ContadoresService[x] = function (r, s, o) { return Q.serviceRequest(ContadoresService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        [['HotelId', function () { return Serenity.LookupEditor; }], ['ClienteId', function () { return Serenity.LookupEditor; }], ['FechaContrato', function () { return Serenity.DateEditor; }], ['FechaDesde', function () { return Serenity.DateEditor; }], ['FechaHasta', function () { return Serenity.DateEditor; }], ['NumeroContratoCliente', function () { return Serenity.StringEditor; }], ['TemporadaId', function () { return Serenity.LookupEditor; }], ['ImpuestoIncluido', function () { return Serenity.BooleanEditor; }], ['MercadoId', function () { return Serenity.LookupEditor; }]].forEach(function (x) { return Object.defineProperty(ContratosForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Contratos = Geshotel.Contratos || (Geshotel.Contratos = {}));
})(Geshotel || (Geshotel = {}));
var Geshotel;
(function (Geshotel) {
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (HabitacionesService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                HabitacionesService[x] = function (r, s, o) { return Q.serviceRequest(HabitacionesService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (ReleasesRow) {
            ...
            ['ReleaseId', 'ClienteId', 'HotelId', 'FechaDesde', 'FechaHasta', 'Observaciones', 'Dias', 'UserId', 'FechaModificacion', 'ClienteRazon', 'HotelName', 'EmpresaId', 'Empresa', 'UserName'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (SeriesRow) {
            ...
            SeriesRow.nameProperty = 'Descripcion';
            SeriesRow.localTextPrefix = 'Contratos.Series';
            var Fields;
            (function (Fields) {
            })(Fields = SeriesRow.Fields || (SeriesRow.Fields = {}));
            ['SerieId', 'EmpresaId', 'Descripcion', 'Abreviatura', 'Manocorriente', 'Visible', 'Factura', 'Deposito', 'ServicioId', 'ImpuestoId', 'Voxel', 'UserId', 'FechaModificacion', 'Empresa', 'UserName'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (SeriesService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                SeriesService[x] = function (r, s, o) { return Q.serviceRequest(SeriesService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (ServiciosHotelRow) {
            ...
            ['ServicioHotelId', 'ServicioId', 'HotelId', 'ImpuestoId', 'Costo', 'CtaContable', 'DptoContable', 'PermiteCredito', 'HotelName', 'EmpresaId', 'Empresa', 'NombreServicio', 'ServicioTipoServicioId', 'ConceptoAceleradorReservasId', 'SwPension', 'Impuesto'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (ServiciosHotelService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ServiciosHotelService[x] = function (r, s, o) { return Q.serviceRequest(ServiciosHotelService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (TiposHabitacionHotelRow) {
            ...
            ['TipoHabitacionHotelId', 'HotelId', 'TipoHabitacionId', 'ServicioId', 'HotelName', 'EmpresaId', 'Empresa', 'TipoHabitacionName', 'ServicioName'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Portal) {
        ...
        (function (HabitacionesSituacionRow) {
            ...
            ['SituacionId', 'Situacion'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Portal) {
        ...
        (function (HabitacionesSituacionService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                HabitacionesSituacionService[x] = function (r, s, o) { return Q.serviceRequest(HabitacionesSituacionService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Portal) {
        ...
        (function (ImpuestosService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ImpuestosService[x] = function (r, s, o) { return Q.serviceRequest(ImpuestosService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Portal) {
        ...
        (function (TiposBloqueoRow) {
            ...
            ['TipoBloqueoId', 'Descriptivo', 'Editable'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Portal) {
        ...
        (function (TiposBloqueoService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                TiposBloqueoService[x] = function (r, s, o) { return Q.serviceRequest(TiposBloqueoService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Portal) {
        ...
        (function (TiposDeTarjetaRow) {
            ...
            ['TipoTarjetaId', 'TipoTarjeta', 'TarjetaLength', 'TarjetaPrefixes', 'TarjetaCheckdigit'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Portal) {
        ...
        (function (TiposDeTarjetaService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                TiposDeTarjetaService[x] = function (r, s, o) { return Q.serviceRequest(TiposDeTarjetaService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Recepcion) {
        ...
        (function (HabitacionesBloqueosService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                HabitacionesBloqueosService[x] = function (r, s, o) { return Q.serviceRequest(HabitacionesBloqueosService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Recepcion) {
        ...
        (function (ReservasOfertasRow) {
            ...
            ['ReservaOfertaId', 'ReservaId', 'OfertaId', 'Tipo', 'Activa', 'OfertaUsada', 'UnidadCalculoId', 'Texto', 'N', 'TipoOfertaId', 'M', 'TipoOfertaName', 'UnidadCalculoName'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Recepcion) {
        ...
        (function (ReservasRow) {
            ...
            ['ReservaId', 'FechaCreacion', 'HotelId', 'EstadoReservaId', 'ClienteId', 'CanalReservaId', 'ClienteIdFactura', 'FechaReserva', 'NombreReserva', 'TipoHabitacionId', 'PensionId', 'Adultos', 'Child50', 'ChildFree', 'Bebes', 'Pax', 'Vip', 'FechaPrevistaLlegada', 'FechaPrevistaSalida', 'ObservacionesLlegada', 'ObservacionesSalida', 'ObservacionesCliente', 'Observaciones', 'FechaLlegada', 'FechaSalida', 'BonoReferencia', 'BonoOnline', 'BloquearTarifa', 'PermiteDevolucion', 'TipoTarjetaId', 'TarjetaCredito', 'Caducidad', 'CodSeguridad', 'ContratoTtoo', 'CodigoOferta', 'Valor', 'ValorValidado', 'FechaValidacion', 'UsuarioValidacion', 'ParoventasCheck', 'CuposCheck', 'ReleaseCheck', 'ReservaDingus', 'DingusImpuestosIncluidos', 'DingusComision', 'ReservaDingusTipo', 'FechaAnulacion', 'UserId', 'FechaModificacion', 'HotelName', 'EmpresaId', 'Empresa', 'EstadoReserva', 'TipoTarjeta', 'ClienteRazon', 'CanalReserva', 'ClienteIdFacturaRazon', 'TipoHabitacion', 'Pension', 'Username', 'ValidationUsername', 'ReservaName', 'Noches'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Recepcion) {
        ...
        (function (ReservasService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'ChangeReservationStatus', 'CheckIn'].forEach(function (x) {
                ReservasService[x] = function (r, s, o) { return Q.serviceRequest(ReservasService.baseUrl + '/' + x, r, s, o); };
...
(function (Geshotel) {
    ...
    (function (Recepcion) {
        ...
        (function (ReservasServiciosRow) {
            ...
            ['ServicioReservaId', 'ReservaId', 'ServicioId', 'UnidadCalculoId', 'FechaDesde', 'FechaHasta', 'Cantidad', 'UserId', 'FechaModificacion', 'FlagContrato', 'PrecioServicio', 'ServicioExtra', 'ServicioNombreServicio', 'UnidadCalculo', 'Username'].forEach(function (x) { return Fields[x] = x; });
