...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (ClientesRow) {
            ...
            ['ClienteId', 'Razon', 'DescCorta', 'EmpresaId', 'AgenciaId', 'ClienteDefecto', 'GrupoClienteId', 'TipoDocumentoId', 'Nif', 'FechaDocumento', 'Direccion', 'Poblacion', 'Zip', 'NacionId', 'ProvinciaId', 'CtaContableAnticipo', 'CtaContable', 'DptoContable', 'CtaDepositos', 'Telefono', 'Email', 'Fax', 'Contacto', 'TelefonoContacto', 'FaxContacto', 'EmailContacto', 'CifFra', 'DireccionFra', 'PoblacionFra', 'ZipFra', 'NacionIdFactura', 'ProvinciaIdFactura', 'ClienteFactura', 'ClienteHuesped', 'PermiteCredito', 'LimiteCredito', 'FacturaAnticipada', 'VencimientoFacturasId', 'UserId', 'FechaModificacion', 'ClienteBavel', 'DingusExtras', 'Empresa', 'Agencia', 'NombreGrupo', 'TipoDocumento', 'Nacion', 'Provincia', 'FacturaNacion', 'FacturaProvincia'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        [['ContratoId', function () { return Serenity.IntegerEditor; }], ['HotelId', function () { return Serenity.IntegerEditor; }], ['ClienteId', function () { return Serenity.IntegerEditor; }], ['FechaContrato', function () { return Serenity.DateEditor; }], ['FechaDesde', function () { return Serenity.DateEditor; }], ['FechaHasta', function () { return Serenity.DateEditor; }], ['ContratoIdOriginal', function () { return Serenity.IntegerEditor; }], ['ContratoIdSiguiente', function () { return Serenity.IntegerEditor; }], ['NumeroContratoCliente', function () { return Serenity.StringEditor; }], ['UserId', function () { return Serenity.IntegerEditor; }], ['FechaModificacion', function () { return Serenity.DateEditor; }], ['TemporadaId', function () { return Serenity.IntegerEditor; }], ['ImpuestoIncluido', function () { return Serenity.BooleanEditor; }], ['MercadoId', function () { return Serenity.IntegerEditor; }], ['ClienteIdPadre', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(ContratosForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Contratos = Geshotel.Contratos || (Geshotel.Contratos = {}));
})(Geshotel || (Geshotel = {}));
var Geshotel;
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (ContratosRow) {
            ...
            ['ContratoId', 'HotelId', 'ClienteId', 'FechaContrato', 'FechaDesde', 'FechaHasta', 'ContratoIdOriginal', 'ContratoIdSiguiente', 'NumeroContratoCliente', 'UserId', 'FechaModificacion', 'TemporadaId', 'ImpuestoIncluido', 'MercadoId', 'ClienteIdPadre'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        [['LineaContratoId', function () { return Serenity.IntegerEditor; }], ['ContratoId', function () { return Serenity.IntegerEditor; }], ['Oferta', function () { return Serenity.BooleanEditor; }], ['Desde', function () { return Serenity.DateEditor; }], ['Hasta', function () { return Serenity.DateEditor; }], ['ServicioId', function () { return Serenity.IntegerEditor; }], ['UnidadCalculoId', function () { return Serenity.IntegerEditor; }], ['FrecuenciaId', function () { return Serenity.IntegerEditor; }], ['TipoImputacionId', function () { return Serenity.IntegerEditor; }], ['Importe', function () { return Serenity.DecimalEditor; }], ['N', function () { return Serenity.IntegerEditor; }], ['TipoOfertaId', function () { return Serenity.IntegerEditor; }], ['M', function () { return Serenity.DecimalEditor; }], ['AmbitoOfertaId', function () { return Serenity.IntegerEditor; }], ['Lunes', function () { return Serenity.BooleanEditor; }], ['Martes', function () { return Serenity.BooleanEditor; }], ['Miercoles', function () { return Serenity.BooleanEditor; }], ['Jueves', function () { return Serenity.BooleanEditor; }], ['Viernes', function () { return Serenity.BooleanEditor; }], ['Sabado', function () { return Serenity.BooleanEditor; }], ['Domingo', function () { return Serenity.BooleanEditor; }], ['PagFactura', function () { return Serenity.IntegerEditor; }], ['UserId', function () { return Serenity.IntegerEditor; }], ['FechaModificacion', function () { return Serenity.DateEditor; }]].forEach(function (x) { return Object.defineProperty(LineasForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Contratos = Geshotel.Contratos || (Geshotel.Contratos = {}));
})(Geshotel || (Geshotel = {}));
var Geshotel;
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        (function (LineasRow) {
            ...
            ['LineaContratoId', 'ContratoId', 'Oferta', 'Desde', 'Hasta', 'ServicioId', 'UnidadCalculoId', 'FrecuenciaId', 'TipoImputacionId', 'Importe', 'N', 'TipoOfertaId', 'M', 'AmbitoOfertaId', 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo', 'PagFactura', 'UserId', 'FechaModificacion'].forEach(function (x) { return Fields[x] = x; });
...
(function (Geshotel) {
    ...
    (function (Contratos) {
        ...
        [['RejillaId', function () { return Serenity.IntegerEditor; }], ['OfertaId', function () { return Serenity.IntegerEditor; }], ['N', function () { return Serenity.IntegerEditor; }], ['TipoCondicionId', function () { return Serenity.IntegerEditor; }], ['TipoAplicacion', function () { return Serenity.IntegerEditor; }], ['M', function () { return Serenity.DecimalEditor; }]].forEach(function (x) { return Object.defineProperty(OfertasRejillasForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(Contratos = Geshotel.Contratos || (Geshotel.Contratos = {}));
})(Geshotel || (Geshotel = {}));
var Geshotel;
(function (Geshotel) {
