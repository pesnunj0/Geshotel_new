...
CREATE TABLE `clientes` (
  ...
  `cliente_defecto` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `Cliente_factura` tinyint(1) NOT NULL DEFAULT '0',
  `Cliente_huesped` tinyint(1) NOT NULL DEFAULT '0',
  `permite_credito` tinyint(1) NOT NULL DEFAULT '0',
  `limite_credito` float DEFAULT NULL,
  `factura_anticipada` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `lineas_de_contrato` (
  ...
  `tipo_oferta_id` smallint(6),
  `n` smallint(6),
  `ambito_oferta_id` smallint(6),
  `m` decimal(10,2),
