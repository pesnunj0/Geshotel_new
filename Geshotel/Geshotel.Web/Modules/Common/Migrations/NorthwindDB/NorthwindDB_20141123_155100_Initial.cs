...
namespace Geshotel.Migrations.NorthwindDB
{
    ...
    public class DefaultDB_20141123_155100_ProductImage : Migration
    {
        public override void Up()
        {
            IfDatabase("SqlServer", "SqlServer2000", "SqlServerCe")
                .Execute.EmbeddedScript("Geshotel.Modules.Common.Migrations.NorthwindDB.NorthwindDBScript_SqlServer.sql");

            IfDatabase("Postgres")
                .Execute.EmbeddedScript("Geshotel.Modules.Common.Migrations.NorthwindDB.NorthwindDBScript_Postgres.sql");

            IfDatabase("Postgres")
                .Execute.EmbeddedScript("Geshotel.Modules.Common.Migrations.NorthwindDB.NorthwindDBScript_PostgresData.sql");

            IfDatabase("MySql")
                .Execute.EmbeddedScript("Geshotel.Modules.Common.Migrations.NorthwindDB.NorthwindDBScript_MySql.sql");

            IfDatabase("Oracle")
                .Execute.EmbeddedScript("Geshotel.Modules.Common.Migrations.NorthwindDB.NorthwindDBScript_Oracle.sql");
