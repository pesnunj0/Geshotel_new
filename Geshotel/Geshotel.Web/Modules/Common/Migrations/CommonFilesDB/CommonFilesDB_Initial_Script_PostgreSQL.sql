...
-- ----------------------------
INSERT INTO formas_de_pago VALUES ('1', 'Contado', '', '', null, null, null, null, '', '');
INSERT INTO formas_de_pago VALUES ('2', 'Credito', '', '', null, null, null, null, '', '');
INSERT INTO formas_de_pago VALUES ('3', 'Transferencia', '', '', null, null, null, null, '', '');
INSERT INTO formas_de_pago VALUES ('4', 'Visa', '', '', '', '13,16', '4', '', '', '');
INSERT INTO formas_de_pago VALUES ('5', 'MasterCard', '', '', '', '16', '51,52,53,54,55', '', '', '');
INSERT INTO formas_de_pago VALUES ('6', '4B', '', '', '', null, null, null, '', '');
INSERT INTO formas_de_pago VALUES ('7', 'Visa TPV Virtual', '', '', '', null, null, null, '', '');
INSERT INTO formas_de_pago VALUES ('8', 'AMEX', '', '', null, null, null, null, '', '');
INSERT INTO formas_de_pago VALUES ('9', 'Cta Casa Propiedad', '', '', null, null, null, null, '', '');
INSERT INTO formas_de_pago VALUES ('10', 'Cta Casa Direccion', '', '', null, null, null, null, '', '');
INSERT INTO formas_de_pago VALUES ('11', 'Cta Casa Animacion', '', '', null, null, null, null, '', '');

-- ----------------------------
-- Table structure for frecuencia_facturacion
-- ----------------------------
DROP TABLE IF EXISTS frecuencia_facturacion;
CREATE SEQUENCE frecuencia_facturacion_seq;

CREATE TABLE frecuencia_facturacion (
  frecuencia_id smallint NOT NULL DEFAULT NEXTVAL ('frecuencia_facturacion_seq'),
  descripcion_corta varchar(3) NOT NULL,
  descripcion varchar(30) NOT NULL,
  PRIMARY KEY (frecuencia_id)
)  ;

ALTER SEQUENCE frecuencia_facturacion_seq RESTART WITH 4;
...
CREATE SEQUENCE grupos_de_cliente_seq;

CREATE TABLE grupos_de_cliente (
  grupo_cliente_id smallint NOT NULL DEFAULT NEXTVAL ('grupos_de_cliente_seq'),
  nombre_grupo varchar(30) NOT NULL,
  huesped boolean(1) NOT NULL DEFAULT b'0',
  contratos boolean(1) NOT NULL DEFAULT b'0',
  facturar boolean(1) NOT NULL DEFAULT b'1',
  agencia boolean(1) NOT NULL DEFAULT b'0',
  perfil smallint DEFAULT NULL,
  PRIMARY KEY (grupo_cliente_id)
)  ;

ALTER SEQUENCE grupos_de_cliente_seq RESTART WITH 6;
...
-- ----------------------------
INSERT INTO grupos_de_cliente VALUES ('1', 'Agencias', '', '', '', '', '800');
INSERT INTO grupos_de_cliente VALUES ('2', 'Contratos', '', '', '', '', '800');
INSERT INTO grupos_de_cliente VALUES ('4', 'Empresas', '', '', '', '', '600');
INSERT INTO grupos_de_cliente VALUES ('5', 'Huespedes', '', '', '', '', '600');

-- ----------------------------
-- Table structure for grupos_de_servicios
-- ----------------------------
DROP TABLE IF EXISTS grupos_de_servicios;
CREATE SEQUENCE grupos_de_servicios_seq;

CREATE TABLE grupos_de_servicios (
  grupo_servicio_id int NOT NULL DEFAULT NEXTVAL ('grupos_de_servicios_seq'),
  nombre_grupo varchar(255) NOT NULL,
  cta_contable varchar(16) NOT NULL,
  PRIMARY KEY (grupo_servicio_id)
)  ;

ALTER SEQUENCE grupos_de_servicios_seq RESTART WITH 4;
...
CREATE TABLE grupos_habitacion (
  grupo_habitacion_id smallint NOT NULL,
...
CREATE SEQUENCE grupos_oferta_seq;

CREATE TABLE grupos_oferta (
  grupo_oferta_id smallint NOT NULL DEFAULT NEXTVAL ('grupos_oferta_seq'),
  grupo_oferta varchar(20) NOT NULL,
  PRIMARY KEY (grupo_oferta_id)
)  ;

ALTER SEQUENCE grupos_oferta_seq RESTART WITH 6;
...
CREATE TABLE hoteles (
  hotel_id smallint NOT NULL DEFAULT NEXTVAL ('hoteles_seq'),
  ...
  contador_fichero_policia int DEFAULT NULL,
  ...
  url_ista text,
  municipio_ista text,
  numero_registro_ista int DEFAULT NULL,
  ...
  checkin_on_line smallint check (checkin_on_line > 0) NOT NULL DEFAULT '0',
  minimo_dias_checkin_online smallint DEFAULT '0',
  zoom_mapa smallint DEFAULT NULL,
  lat double precision DEFAULT NULL,
  lng double precision DEFAULT NULL,
  ancho smallint DEFAULT NULL,
  alto smallint DEFAULT NULL,
  overbooking_limit double precision DEFAULT NULL,
...
ALTER SEQUENCE hoteles_seq RESTART WITH 5;
...
CREATE SEQUENCE impuestos_seq;

CREATE TABLE impuestos (
  impuesto_id smallint NOT NULL DEFAULT NEXTVAL ('impuestos_seq'),
  empresa_id smallint NOT NULL,
  impuesto varchar(30) NOT NULL,
  porcentaje double precision NOT NULL,
  cta_contable varchar(15) DEFAULT NULL,
  activo_geshotel smallint DEFAULT '0',
  user_id smallint DEFAULT NULL,
  fecha_actualizacion timestamp(0) DEFAULT NULL,
  PRIMARY KEY (impuesto_id)
)  ;

ALTER SEQUENCE impuestos_seq RESTART WITH 14;
...
CREATE SEQUENCE monedas_seq;

CREATE TABLE monedas (
  moneda_id smallint NOT NULL DEFAULT NEXTVAL ('monedas_seq'),
  descripcion varchar(20) NOT NULL,
  desc_corta varchar(10) NOT NULL,
  cambio double precision DEFAULT NULL,
  PRIMARY KEY (moneda_id)
)  ;

ALTER SEQUENCE monedas_seq RESTART WITH 10;
...
ALTER SEQUENCE naciones_seq RESTART WITH 31;
...
CREATE TABLE provincias (
  provincia_id smallint NOT NULL DEFAULT NEXTVAL ('provincias_seq'),
  provincia varchar(30) NOT NULL,
  comunidad_autonoma_id smallint DEFAULT NULL,
  nacion_id smallint NOT NULL,
  provincia_ista varchar(6) DEFAULT NULL,
  defecto_ista smallint DEFAULT '0',
...
ALTER SEQUENCE provincias_seq RESTART WITH 54;
...
CREATE TABLE series (
  ...
  manocorriente smallint DEFAULT NULL,
  visible smallint DEFAULT NULL,
  factura smallint DEFAULT NULL,
  deposito smallint DEFAULT '0',
  servicio_id int DEFAULT NULL,
  impuesto_id int DEFAULT NULL,
  voxel smallint DEFAULT NULL,
...
CREATE TABLE servicios (
  servicio_id int NOT NULL DEFAULT NEXTVAL ('servicios_seq'),
  nombre_servicio varchar(50) NOT NULL,
  abreviatura varchar(6) NOT NULL,
  tipo_servicio_id smallint NOT NULL,
  sw_produccion boolean(4) NOT NULL DEFAULT b'1',
  sw_descuento boolean(4) DEFAULT b'0',
  sw_ajustes boolean(4) DEFAULT b'0',
  sw_gastos boolean(4) DEFAULT b'0',
  sw_pension boolean(4) NOT NULL DEFAULT b'0',
  sw_rectificativa boolean(4) DEFAULT b'0',
  tipo_unidad_calculo_id smallint DEFAULT NULL,
  concepto_acelerador_reservas_id smallint DEFAULT NULL,
  costo double precision DEFAULT '0.00',
  suma_servicio_id int DEFAULT NULL,
  resta_servicio_id int DEFAULT NULL,
  user_id int DEFAULT NULL,
  fecha_modificacion timestamp(0) DEFAULT NULL,
  tipo_hab smallint DEFAULT NULL,
  tipo_pension smallint DEFAULT NULL,
...
ALTER SEQUENCE servicios_seq RESTART WITH 245;
...
-- ----------------------------
INSERT INTO servicios VALUES ('1', 'Alojamiento B1', 'A1', '1', '', '', '', '', '', '', '2', '99', null, null, null, '1', '2008-12-10 00:00:00', '1', null);
INSERT INTO servicios VALUES ('2', 'Desayuno', 'HD', '2', '', '', '', '', '', '', '2', '2', null, null, null, '1', '2009-02-02 00:00:00', null, '1');
INSERT INTO servicios VALUES ('3', 'Media Pension', 'MP', '2', '', '', '', '', '', '', '2', '2', null, null, null, '2', '2011-03-11 00:00:00', null, '2');
INSERT INTO servicios VALUES ('4', 'Todo Incluido', 'TI', '2', '', '', '', '', '', '', '2', '2', null, null, null, '1', '2011-08-17 00:00:00', null, '4');
INSERT INTO servicios VALUES ('5', 'Todo Incluido Bebidas', 'TIB', '2', '', '', '', '', '', '', '2', '2', null, null, null, '7', null, null, '4');
INSERT INTO servicios VALUES ('6', 'Alojamiento B2', 'A2', '1', '', '', '', '', '', '', '2', '99', null, null, null, '7', '2015-08-24 00:00:00', '2', null);
INSERT INTO servicios VALUES ('7', 'Cunas', 'CUN', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', null, null, null);
INSERT INTO servicios VALUES ('8', 'Gala Navidad HD', 'GNHD', '5', '', '', '', '', '', '', '2', null, null, null, null, '7', null, null, null);
INSERT INTO servicios VALUES ('9', 'Gala Fin de Año', 'GF', '5', '', '', '', '', '', '', '2', null, null, null, null, '7', '2015-01-14 00:00:00', null, null);
INSERT INTO servicios VALUES ('10', 'Bungalow 1 Dormitorio', 'B1', '1', '', '', '', '', '', '', '1', '1', null, null, null, '7', null, '1', null);
INSERT INTO servicios VALUES ('11', 'Bungalow 2 Dormitorios', 'B2', '1', '', '', '', '', '', '', '1', '1', null, null, null, '7', null, '2', null);
INSERT INTO servicios VALUES ('12', 'Bar Piscina 1 Comidas', 'BP1C', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', null, null, null);
INSERT INTO servicios VALUES ('13', 'Bar Piscina 1 Bebidas', 'BP1B', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', null, null, null);
INSERT INTO servicios VALUES ('14', 'Bar Salon Bebidas', 'BSB', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', null, null, null);
INSERT INTO servicios VALUES ('15', 'Bar Piscina 2 Comidas ', 'BP2C', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', null, null, null);
INSERT INTO servicios VALUES ('16', 'Bar Piscina 2 Bebidas ', 'BP2B', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', null, null, null);
INSERT INTO servicios VALUES ('17', 'Bar Restaurante Bebidas', 'BRB', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-07-29 00:00:00', null, null);
INSERT INTO servicios VALUES ('18', 'Bar Restaurante Comidas', 'BRC', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-10-07 00:00:00', null, null);
INSERT INTO servicios VALUES ('19', 'Gala Navidad', 'GN', '5', '', '', '', '', '', '', '2', null, null, null, null, '7', null, null, null);
INSERT INTO servicios VALUES ('20', 'Gala Fin de Año HD', 'GFHD', '5', '', '', '', '', '', '', '2', null, null, null, null, '7', null, null, null);
INSERT INTO servicios VALUES ('23', 'Habitacion Overbooking', 'HAOVB', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-01-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('31', 'Alquiler de Sombrilla', 'ALQSO', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-01-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('33', 'Cabinas Telefonicas', 'CABTF', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-01-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('37', 'Divisa', 'DIVIS', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-01-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('38', 'Exposiciones y Desfiles', 'EXPOS', '3', '', '', '', '', '', '', '1', null, null, null, null, '37', '2015-05-12 00:00:00', null, null);
INSERT INTO servicios VALUES ('39', 'Internet', 'INTER', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-01-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('40', 'Lavadoras', 'LAVAD', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-01-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('42', 'Caja de Seguridad', 'SAFE', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-01-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('43', 'Tabaco', 'TAB', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-01-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('44', 'Telefono', 'TELEF', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-01-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('45', 'Babychangingtable (Cambiador)', 'CAMBI', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-02-04 00:00:00', null, null);
INSERT INTO servicios VALUES ('47', 'Babytrolly (Carrito)', 'CARRI', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-02-04 00:00:00', null, null);
INSERT INTO servicios VALUES ('48', 'Rent a Car', 'RENT', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-08-07 00:00:00', null, null);
INSERT INTO servicios VALUES ('49', 'Tenis', 'TENIS', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-02-04 00:00:00', null, null);
INSERT INTO servicios VALUES ('50', 'Babychair (Trona)', 'TRONA', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-02-04 00:00:00', null, null);
INSERT INTO servicios VALUES ('51', 'Wellness Center', 'WELLN', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-02-04 00:00:00', null, null);
INSERT INTO servicios VALUES ('52', 'Wellcome Package', 'WPACK', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-02-04 00:00:00', null, null);
INSERT INTO servicios VALUES ('53', 'Alojamiento Premier', 'AP', '1', '', '', '', '', '', '', '2', '99', null, null, null, '1', '2009-03-04 00:00:00', '3', null);
INSERT INTO servicios VALUES ('54', 'Alojamiento Kid Suite', 'AKS', '1', '', '', '', '', '', '', '2', '99', null, null, null, '1', '2009-03-04 00:00:00', '4', null);
INSERT INTO servicios VALUES ('55', 'Premier', 'PRE', '1', '', '', '', '', '', '', '1', '1', null, null, null, '1', '2009-03-04 00:00:00', '3', null);
INSERT INTO servicios VALUES ('56', 'Kid Suite', 'KS', '1', '', '', '', '', '', '', '1', '1', null, null, null, '1', '2009-03-04 00:00:00', '4', null);
INSERT INTO servicios VALUES ('57', 'Pension Completa', 'PC', '2', '', '', '', '', '', '', '2', '2', null, null, null, '1', '2009-06-02 00:00:00', null, '3');
INSERT INTO servicios VALUES ('60', 'Varios', 'Var', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-03-11 00:00:00', null, null);
INSERT INTO servicios VALUES ('61', 'Upgrade de B1 a B2', 'B1AB2', '1', '', '', '', '', '', '', '1', null, null, '11', '10', '2', '2009-06-14 00:00:00', null, null);
INSERT INTO servicios VALUES ('62', 'Descuento Publicidad Habitacion', 'DESH', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2015-09-09 00:00:00', null, null);
INSERT INTO servicios VALUES ('63', 'Descuento Pension', 'DESP', '2', '', '', '', '', '', '', '1', null, null, null, null, '2', '2009-04-14 00:00:00', null, null);
INSERT INTO servicios VALUES ('65', 'Descuento Cobro', 'Desc', '3', '', '', '', '', '', '', '1', null, '0.00', null, null, '2', '2009-05-18 13:47:27', null, null);
INSERT INTO servicios VALUES ('66', 'Anticipo Factura', 'ANT', '3', '', '', '', '', '', '', '1', null, '0.00', null, null, '2', '2009-05-18 13:49:24', null, null);
INSERT INTO servicios VALUES ('69', 'Depositos', 'DEP', '7', '', '', '', '', '', '', '1', null, '0.00', null, null, '2', '2009-10-27 00:00:00', null, null);
INSERT INTO servicios VALUES ('70', 'Ajustes Produccion Pension', 'AJPEN', '2', '', '', '', '', '', '', '1', null, null, null, null, '2', '2009-05-29 00:00:00', null, null);
INSERT INTO servicios VALUES ('71', 'Ajustes Produccion Habitacion', 'AJUHA', '1', '', '', '', '', '', '', '1', null, null, null, null, '2', '2009-05-29 00:00:00', null, null);
INSERT INTO servicios VALUES ('72', 'Ajustes Produccion Galas', 'AJUGA', '5', '', '', '', '', '', '', '1', null, null, null, null, '2', '2009-05-29 00:00:00', null, null);
INSERT INTO servicios VALUES ('73', 'Ajustes Produccion Otros', 'AJUOT', '3', '', '', '', '', '', '', '1', null, null, null, null, '2', '2009-05-29 00:00:00', null, null);
INSERT INTO servicios VALUES ('74', 'Habitacion Permisos (Late check out)', 'PER', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-08-22 00:00:00', null, null);
INSERT INTO servicios VALUES ('75', 'Upgrade B2 A KS', 'B2AKS', '1', '', '', '', '', '', '', '1', null, null, '56', '11', '2', '2009-06-14 00:00:00', null, null);
INSERT INTO servicios VALUES ('76', 'Animadores', 'ANIM', '1', '', '', '', '', '', '', '1', null, null, null, null, '2', '2009-06-18 00:00:00', null, null);
INSERT INTO servicios VALUES ('77', 'Upgrade MP a TI', 'MP2TI', '2', '', '', '', '', '', '', '2', null, null, '4', '3', '2', '2009-06-23 00:00:00', null, '4');
INSERT INTO servicios VALUES ('78', 'Persona Extra SA/día', 'CS', '3', '', '', '', '', '', '', '1', null, null, null, null, '37', '2015-06-01 00:00:00', null, null);
INSERT INTO servicios VALUES ('79', 'Varios Golosinas', 'GOLOS', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-07-03 00:00:00', null, null);
INSERT INTO servicios VALUES ('80', 'Salón de Conferencias', 'CONFE', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2015-11-24 00:00:00', null, null);
INSERT INTO servicios VALUES ('83', 'Sillon de Masajes', 'SILLO', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-07-03 00:00:00', null, null);
INSERT INTO servicios VALUES ('84', 'Bisutería', 'BISUT', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-07-03 00:00:00', null, null);
INSERT INTO servicios VALUES ('85', 'Roturas', 'ROTUR', '3', '', '', '', '', '', '', '1', null, null, null, null, '9', '2009-09-29 00:00:00', null, null);
INSERT INTO servicios VALUES ('86', 'Publicidad', 'PUBLI', '6', '', '', '', '', '', '', '1', null, '0.00', null, null, '2', '2009-07-03 10:30:02', null, null);
INSERT INTO servicios VALUES ('87', 'Luz para Tenis', 'Luz', '3', '', '', '', '', '', '', '1', null, null, null, null, '2', '2009-07-08 00:00:00', null, null);
INSERT INTO servicios VALUES ('88', 'Upgrade Desayuno a TI', 'De2TI', '2', '', '', '', '', '', '', '2', null, null, '4', '2', '2', '2009-07-09 00:00:00', null, '4');
INSERT INTO servicios VALUES ('89', 'Upgrade Desayuno a MP', 'DE2MP', '2', '', '', '', '', '', '', '2', null, null, '3', '2', '2', '2009-07-09 00:00:00', null, '2');
INSERT INTO servicios VALUES ('90', 'Suplemento Gala Navidad MP (contratos)', 'GNMP', '5', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-12-22 00:00:00', null, null);
INSERT INTO servicios VALUES ('91', 'Suplemento Gala Navidad TI (contratos)', 'GNTI', '5', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-12-22 00:00:00', null, null);
INSERT INTO servicios VALUES ('92', 'Suplemento Gala Fin de Año MP (contratos)', 'GFMP', '5', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-12-22 00:00:00', null, null);
INSERT INTO servicios VALUES ('93', 'Suplemento Gala Fin de Año TI (contratos)', 'GFTI', '5', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-12-22 00:00:00', null, null);
INSERT INTO servicios VALUES ('94', 'Suite 1 Dormitorio', 'SUITE1', '1', '', '', '', '', '', '', '1', '1', null, null, null, '7', '2013-10-04 00:00:00', '1', null);
INSERT INTO servicios VALUES ('95', 'Suite 2 Dormitorios', 'SUITE2', '1', '', '', '', '', '', '', '1', '1', null, null, null, '7', '2013-10-04 00:00:00', '2', null);
INSERT INTO servicios VALUES ('96', 'Alojamiento Suite 1', 'SU1', '1', '', '', '', '', '', '', '2', '99', null, null, null, '7', '2013-10-04 00:00:00', '1', null);
INSERT INTO servicios VALUES ('97', 'Alojamiento Suite 2', 'SU2', '1', '', '', '', '', '', '', '2', '99', null, null, null, '7', '2013-10-04 00:00:00', '2', null);
INSERT INTO servicios VALUES ('98', 'Upgrade A1 a A2', 'A1UA2', '1', '', '', '', '', '', '', '1', null, null, '95', '94', '2', '2009-07-20 00:00:00', null, null);
INSERT INTO servicios VALUES ('99', 'Upgrade A2 a KS', 'A2UKS', '1', '', '', '', '', '', '', '1', null, null, '56', '95', '2', '2009-07-20 00:00:00', null, null);
INSERT INTO servicios VALUES ('100', 'Calefaccion', 'Cal', '3', '', '', '', '', '', '', '1', null, null, null, null, '2', '2009-07-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('103', 'Carga Partidas vivas', 'CCI', '3', '', '', '', '', '', '', '1', null, '0.00', null, null, '2', '2009-07-31 00:00:00', null, null);
INSERT INTO servicios VALUES ('104', 'Comisión bancaria', 'Comis', '6', '', '', '', '', '', '', '1', null, '0.00', null, null, '7', '2009-08-28 16:48:22', null, null);
INSERT INTO servicios VALUES ('105', 'Provisión Publicidad', 'ProvP', '6', '', '', '', '', '', '', '1', null, '0.00', null, null, '7', '2009-08-28 16:48:46', null, null);
INSERT INTO servicios VALUES ('106', 'Habitación Rectificativa', 'HABRE', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-06-28 00:00:00', null, null);
INSERT INTO servicios VALUES ('107', 'Desayuno rectificativa', 'DESRE', '2', '', '', '', '', '', '', '2', null, null, null, null, '7', '2011-06-28 00:00:00', null, null);
INSERT INTO servicios VALUES ('108', 'Media Pensión Rectificativa', 'MPRE', '2', '', '', '', '', '', '', '2', null, null, null, null, '7', '2011-06-28 00:00:00', null, null);
INSERT INTO servicios VALUES ('109', 'Todo Incluido Rectificativa', 'TIRE', '2', '', '', '', '', '', '', '2', null, null, null, null, '7', '2011-06-28 00:00:00', null, null);
INSERT INTO servicios VALUES ('110', 'Supl. Doble Uso Ind.', 'SDUI', '1', '', '', '', '', '', '', '1', null, null, null, null, '9', '2009-09-29 00:00:00', null, null);
INSERT INTO servicios VALUES ('111', 'Coco´s birthday', 'COCO', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-10-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('112', 'Artículos Merchandising', 'MERCHA', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-06-18 00:00:00', null, null);
INSERT INTO servicios VALUES ('114', 'Regularización cobro', 'REGUL', '6', '', '', '', '', '', '', '1', null, '0.00', null, null, '7', '2009-11-30 11:09:21', null, null);
INSERT INTO servicios VALUES ('115', 'Produccion Habitacion Garantia', 'GAR', '1', '', '', '', '', '', '', '1', null, null, null, null, '2', '2009-12-04 00:00:00', null, null);
INSERT INTO servicios VALUES ('116', 'Solo Alojamiento', 'SS', '2', '', '', '', '', '', '', '2', null, '0.00', null, null, '1', '2009-12-25 19:48:23', null, null);
INSERT INTO servicios VALUES ('117', 'Habitacion', 'HAB', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2009-12-30 00:00:00', null, null);
INSERT INTO servicios VALUES ('119', 'Mando TV', 'TV', '3', '', '', '', '', '', '', '1', null, null, null, null, '2', '2010-04-08 00:00:00', null, null);
INSERT INTO servicios VALUES ('120', 'Snack', 'SNK', '3', '', '', '', '', '', '', '1', null, null, null, null, '2', '2010-04-14 00:00:00', null, null);
INSERT INTO servicios VALUES ('121', 'Pesa', 'PES', '3', '', '', '', '', '', '', '1', null, null, null, null, '2', '2010-04-14 00:00:00', null, null);
INSERT INTO servicios VALUES ('122', 'Upgrade Cenas ', 'CEN', '2', '', '', '', '', '', '', '1', null, null, '3', null, '7', '2011-02-15 00:00:00', null, '2');
INSERT INTO servicios VALUES ('123', 'Cenas Niños', 'CEN', '2', '', '', '', '', '', '', '1', null, null, '3', null, '2', '2010-04-14 00:00:00', null, '2');
INSERT INTO servicios VALUES ('124', 'Upgrade de A1 a PRE', 'UA1PR', '1', '', '', '', '', '', '', '1', null, null, '55', '94', '1', '2010-07-14 00:00:00', null, null);
INSERT INTO servicios VALUES ('125', 'Almuerzo', 'ALMUE', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', '2010-05-25 00:00:00', null, null);
INSERT INTO servicios VALUES ('126', 'Merchandising', 'MERCH', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2010-07-26 00:00:00', null, null);
INSERT INTO servicios VALUES ('127', 'SIAM PARK', 'SIAM', '3', '', '', '', '', '', '', '2', null, null, null, null, '7', '2010-08-18 00:00:00', null, null);
INSERT INTO servicios VALUES ('128', 'Misnusvalidos 1 Dorm', 'M1', '1', '', '', '', '', '', '', '1', '1', null, null, null, '2', '2010-10-07 00:00:00', '1', null);
INSERT INTO servicios VALUES ('129', 'Minusvalidos 2 Dorm.', 'M2', '1', '', '', '', '', '', '', '1', '1', null, null, null, '2', '2010-10-07 00:00:00', '2', null);
INSERT INTO servicios VALUES ('130', 'Alojamiento M1', 'AM1', '1', '', '', '', '', '', '', '2', '99', null, null, null, '2', '2010-10-07 00:00:00', '1', null);
INSERT INTO servicios VALUES ('131', 'Alojamiento M2', 'AM2', '1', '', '', '', '', '', '', '2', '99', null, null, null, '2', '2010-10-07 00:00:00', '2', null);
INSERT INTO servicios VALUES ('132', 'Máquinas recreativas', 'RECRE', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-10-16 00:00:00', null, null);
INSERT INTO servicios VALUES ('133', 'Báscula maletas', 'BASCU', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2010-10-15 00:00:00', null, null);
INSERT INTO servicios VALUES ('134', 'Máquinas expendedoras (VENDING)', 'EXPEN', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-01-24 00:00:00', null, null);
INSERT INTO servicios VALUES ('135', 'Máquinas de café', 'CAFÉ', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2010-11-30 00:00:00', null, null);
INSERT INTO servicios VALUES ('136', 'Upgrade SS a HD', 'SSHD', '2', '', '', '', '', '', '', '2', '2', null, '2', null, '7', '2010-12-22 00:00:00', null, '1');
INSERT INTO servicios VALUES ('137', 'Upgrade SS a MP', 'SSMP', '2', '', '', '', '', '', '', '2', '2', null, '3', null, '7', '2010-12-22 00:00:00', null, '2');
INSERT INTO servicios VALUES ('138', 'Upgrade SS a TI', 'SSTI', '2', '', '', '', '', '', '', '2', '2', null, '4', null, '7', '2010-12-22 00:00:00', null, '4');
INSERT INTO servicios VALUES ('139', 'Gala Navidad pasante 24.12', 'GNAP', '5', '', '', '', '', '', '', '2', null, null, null, null, '7', '2014-12-24 00:00:00', null, null);
INSERT INTO servicios VALUES ('140', 'Gala Fin de Año pasante', 'GFINP', '5', '', '', '', '', '', '', '2', null, null, null, null, '7', '2014-12-24 00:00:00', null, null);
INSERT INTO servicios VALUES ('141', 'Suplemento Gala Navidad SS (contratos)', 'GNSS', '5', '', '', '', '', '', '', '2', '2', null, null, null, '7', '2011-12-22 00:00:00', null, null);
INSERT INTO servicios VALUES ('142', 'Suplemento Gala Fin de Año SS (contratos)', 'GFISS', '5', '', '', '', '', '', '', '2', '2', null, null, null, '7', '2011-12-22 00:00:00', null, null);
INSERT INTO servicios VALUES ('143', 'Kid Suite +', 'KS+', '1', '', '', '', '', '', '', '1', '1', null, null, null, '2', '2011-01-27 00:00:00', '4', null);
INSERT INTO servicios VALUES ('144', 'Alojamiento KS+', 'AKS+', '1', '', '', '', '', '', '', '2', '99', null, null, null, '2', '2011-01-27 00:00:00', '4', null);
INSERT INTO servicios VALUES ('145', 'Productos Lavandería', 'LAVAN', '3', '', '', '', '', '', '', '1', null, null, null, null, '37', '2011-02-04 00:00:00', null, null);
INSERT INTO servicios VALUES ('146', 'Compensaciones OVB', 'COVB', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-03-02 00:00:00', null, null);
INSERT INTO servicios VALUES ('147', 'Compensaciones', 'COMP', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-03-02 00:00:00', null, null);
INSERT INTO servicios VALUES ('148', 'Pretty Woman', 'PREWO', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-04-18 00:00:00', null, null);
INSERT INTO servicios VALUES ('149', 'Junior Suite Mar', 'JSM', '1', '', '', '', '', '', '', '1', '1', '0.00', null, null, '2', '2011-06-13 14:02:54', '1', null);
INSERT INTO servicios VALUES ('150', 'Alojamiento Junior Suite Mar', 'AJSM', '1', '', '', '', '', '', '', '2', '99', '0.00', null, null, '2', '2011-06-13 16:17:44', '1', null);
INSERT INTO servicios VALUES ('151', 'Suite Mar', 'SUITM', '1', '', '', '', '', '', '', '1', '1', '0.00', null, null, '2', '2011-06-13 16:18:51', '2', null);
INSERT INTO servicios VALUES ('152', 'Alojamiento Suite Mar', 'ASUIT', '1', '', '', '', '', '', '', '2', '99', '0.00', null, null, '2', '2011-06-13 16:19:43', '2', null);
INSERT INTO servicios VALUES ('153', 'Duplex Mar', 'DUPM', '1', '', '', '', '', '', '', '1', '1', '0.00', null, null, '2', '2011-06-13 16:20:38', '4', null);
INSERT INTO servicios VALUES ('154', 'Alojamiento Duplex Mar', 'ADUPM', '1', '', '', '', '', '', '', '2', '99', '0.00', null, null, '2', '2011-06-13 16:22:19', '4', null);
INSERT INTO servicios VALUES ('156', 'Junior Suite', 'JS', '1', '', '', '', '', '', '', '1', '1', '0.00', null, null, '2', '2011-06-14 16:47:28', '1', null);
INSERT INTO servicios VALUES ('157', 'Alojamiento Junior Suite', 'AJS', '1', '', '', '', '', '', '', '2', '99', '0.00', null, null, '7', '2013-01-24 00:00:00', '1', null);
INSERT INTO servicios VALUES ('159', 'Suite', 'SUIT', '1', '', '', '', '', '', '', '1', '1', '0.00', null, null, '2', '2011-06-14 16:49:38', '2', null);
INSERT INTO servicios VALUES ('160', 'Alojamiento Suite', 'ASUIT', '1', '', '', '', '', '', '', '2', '99', '0.00', null, null, '2', '2011-06-14 16:50:58', '2', null);
INSERT INTO servicios VALUES ('161', 'Duplex', 'DUP', '1', '', '', '', '', '', '', '1', '1', '0.00', null, null, '2', '2011-06-14 16:52:32', '4', null);
INSERT INTO servicios VALUES ('162', 'Alojamiento Duplex', 'ADUP', '1', '', '', '', '', '', '', '2', '99', '0.00', null, null, '2', '2011-06-14 16:53:21', '4', null);
INSERT INTO servicios VALUES ('163', 'HD Spa Wellness Center', 'SPA', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-06-15 00:00:00', null, null);
INSERT INTO servicios VALUES ('164', 'Limpieza toallas', 'LTOAL', '3', '', '', '', '', '', '', '1', null, null, null, null, '2', '2011-09-28 00:00:00', null, null);
INSERT INTO servicios VALUES ('165', 'Snack Bar', 'SNACK', '4', '', '', '', '', '', '', '1', '2', null, null, null, '7', '2012-02-10 00:00:00', null, null);
INSERT INTO servicios VALUES ('166', 'Comisión Transfer', 'TRANS', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-07-06 00:00:00', null, null);
INSERT INTO servicios VALUES ('167', 'Ingresos Reciclaje', 'IREC', '3', '', '', '', '', '', '', '1', null, null, null, null, '2', '2011-07-26 00:00:00', null, null);
INSERT INTO servicios VALUES ('168', 'Flores y tartas habitaciones', 'FLTA', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-08-31 00:00:00', null, null);
INSERT INTO servicios VALUES ('169', 'Impresiones y fotocopias', 'IMFOT', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-08-31 00:00:00', null, null);
INSERT INTO servicios VALUES ('170', 'Restaurante Italiano (Bebidas)', 'ITALI', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-06-18 00:00:00', null, null);
INSERT INTO servicios VALUES ('171', 'Venta productos estética (spa HDBR)', 'VTAES', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2015-09-14 00:00:00', null, null);
INSERT INTO servicios VALUES ('172', 'Alquiler DVDs', 'DVD', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-10-04 00:00:00', null, null);
INSERT INTO servicios VALUES ('173', 'Upgrade de A1 a Kid Suite', 'A1KS', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-10-05 00:00:00', null, null);
INSERT INTO servicios VALUES ('174', 'Alquiler electrodomésticos', 'ELECT', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-10-14 00:00:00', null, null);
INSERT INTO servicios VALUES ('175', 'Cancelaciones reservas', 'CANCE', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-08-08 00:00:00', null, null);
INSERT INTO servicios VALUES ('176', 'Upgrade Cena Japones', 'JAPO', '2', '', '', '', '', '', '', '1', null, null, '3', null, '2', '2011-11-03 00:00:00', null, '2');
INSERT INTO servicios VALUES ('177', 'Descuento publicidad pensión', 'DtoPu', '2', '', '', '', '', '', '', '1', null, null, null, null, '7', '2015-09-09 00:00:00', null, null);
INSERT INTO servicios VALUES ('178', 'Gala Navidad pasante 25.12', 'GNA25', '5', '', '', '', '', '', '', '2', null, null, null, null, '7', '2011-12-20 00:00:00', null, null);
INSERT INTO servicios VALUES ('179', 'Upgrade MP/TI-Gala 24/12', 'UG24', '4', '', '', '', '', '', '', '2', null, null, null, null, '7', '2011-12-22 00:00:00', null, null);
INSERT INTO servicios VALUES ('180', 'Upgrade MP/TI-Gala 25/12', 'UG25', '4', '', '', '', '', '', '', '2', null, null, null, null, '7', '2011-12-22 00:00:00', null, null);
INSERT INTO servicios VALUES ('181', 'Upgrade MP/TI-Gala 31/12', 'UG31', '4', '', '', '', '', '', '', '2', null, null, null, null, '7', '2011-12-22 00:00:00', null, null);
INSERT INTO servicios VALUES ('182', 'Aportación publicidad-guías', 'PBGUI', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-11-12 00:00:00', null, null);
INSERT INTO servicios VALUES ('183', 'Suplemento Vista Mar', 'Vista', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2011-12-30 00:00:00', null, null);
INSERT INTO servicios VALUES ('184', 'Seguro Bicicletas', 'BICI', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-01-11 00:00:00', null, null);
INSERT INTO servicios VALUES ('185', 'Paquete material nautico', 'MATNA', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-02-29 00:00:00', null, null);
INSERT INTO servicios VALUES ('186', 'Curso de Windsurf y Catamarán', 'WIDCA', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-02-29 00:00:00', null, null);
INSERT INTO servicios VALUES ('187', 'Cena', 'CENA', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-05-12 00:00:00', null, null);
INSERT INTO servicios VALUES ('188', 'Habitación interempresa', 'HABINT', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-03-30 00:00:00', null, null);
INSERT INTO servicios VALUES ('189', 'Todo Incuido interempresa', 'TINTE', '2', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-03-30 00:00:00', null, null);
INSERT INTO servicios VALUES ('190', 'Alojamiento Interempresa', 'AINT', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-03-30 00:00:00', null, null);
INSERT INTO servicios VALUES ('191', 'Habitación rectificativa interempresa', 'Rinte', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-05-07 00:00:00', null, null);
INSERT INTO servicios VALUES ('192', 'Todo Incluido Rectificativa Interempresa', 'TIRIN', '2', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-05-07 00:00:00', null, null);
INSERT INTO servicios VALUES ('193', 'Restaurante Italiano (Comidas)', 'ITACO', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-06-18 00:00:00', null, null);
INSERT INTO servicios VALUES ('194', 'Restaurante principal (Comidas)', 'RESTP', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-03-26 00:00:00', null, null);
INSERT INTO servicios VALUES ('195', 'Restaurante principal (Bebidas)', 'RESTP', '4', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-06-18 00:00:00', null, null);
INSERT INTO servicios VALUES ('196', 'Upgrade Premier a B2', 'UPRB2', '1', '', '', '', '', '', '', '1', null, null, '11', '55', '7', '2012-08-01 00:00:00', null, null);
INSERT INTO servicios VALUES ('197', 'Aire Acondicionado', 'AIRE', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-09-20 00:00:00', null, null);
INSERT INTO servicios VALUES ('198', 'VIP PACKAGE', 'PVIP', '3', '', '', '', '', '', '', '2', null, null, null, null, '7', '2012-11-16 00:00:00', null, null);
INSERT INTO servicios VALUES ('199', 'Peticiones obsequios para clientes(tartas, vino..)', 'OBSEQ', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-12-21 00:00:00', null, null);
INSERT INTO servicios VALUES ('200', 'Suplemento Gala Navidad TI (contratos) 25.12', 'NTI25', '5', '', '', '', '', '', '', '1', null, null, null, null, '7', '2012-12-24 00:00:00', null, null);
INSERT INTO servicios VALUES ('201', 'Publicidad Marketing Dinámico', 'MARKE', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-02-19 00:00:00', null, null);
INSERT INTO servicios VALUES ('202', 'Masajes', 'MASAJ', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-02-27 00:00:00', null, null);
INSERT INTO servicios VALUES ('203', 'Suite Premier', 'A1PRE', '1', '', '', '', '', '', '', '1', '1', '0.00', null, null, '2', '2013-10-04 00:00:00', '3', null);
INSERT INTO servicios VALUES ('204', 'Suite Tecnologica', 'TECS2', '1', '', '', '', '', '', '', '1', '1', '0.00', null, null, '2', '2013-10-04 00:00:00', '4', null);
INSERT INTO servicios VALUES ('205', 'Alojamiento SUPRE', 'AA1PR', '1', '', '', '', '', '', '', '2', '99', '0.00', null, null, '2', '2013-10-04 00:00:00', '3', null);
INSERT INTO servicios VALUES ('206', 'Alojamiento TECS2', 'AA2PR', '1', '', '', '', '', '', '', '2', '99', '0.00', null, null, '2', '2013-10-04 00:00:00', '4', null);
INSERT INTO servicios VALUES ('207', 'Desayuno interempresa', 'DESIN', '2', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-04-09 00:00:00', null, null);
INSERT INTO servicios VALUES ('208', 'Venta cápsulas café', 'CAFÉ', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-06-13 00:00:00', null, null);
INSERT INTO servicios VALUES ('209', 'Venta Pizzas', 'PIZZA', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-06-20 00:00:00', null, null);
INSERT INTO servicios VALUES ('210', 'Alquiler Ipad', 'Ipad', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-06-26 00:00:00', null, null);
INSERT INTO servicios VALUES ('211', 'Paquete Naútico', 'NAUTI', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-07-30 00:00:00', null, null);
INSERT INTO servicios VALUES ('212', 'Alquiler MIFI', 'MIFI', '3', '', '', '', '', '', '', '1', null, null, null, null, '2', '2013-09-12 00:00:00', null, null);
INSERT INTO servicios VALUES ('213', 'Comida Animadores', 'Anima', '2', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-10-22 00:00:00', null, null);
INSERT INTO servicios VALUES ('214', 'Habitación permisos contrato (Late check-out)', 'LCOC', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2013-10-23 00:00:00', null, null);
INSERT INTO servicios VALUES ('215', 'Producción garantía no ocupada', 'GNocu', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-01-27 00:00:00', null, null);
INSERT INTO servicios VALUES ('216', 'Venta de aceite vegetal usado', 'ACEIT', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-02-28 00:00:00', null, null);
INSERT INTO servicios VALUES ('217', 'Arrendamiento Terraza', 'ARREN', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-02-28 00:00:00', null, null);
INSERT INTO servicios VALUES ('218', 'Refacturaciones consumos', 'CONSU', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-03-12 00:00:00', null, null);
INSERT INTO servicios VALUES ('219', 'Fotografía', 'FOTO', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-05-09 00:00:00', null, null);
INSERT INTO servicios VALUES ('220', 'Pintura', 'PINTU', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-05-09 00:00:00', null, null);
INSERT INTO servicios VALUES ('221', 'Suplemento Sailor', 'SAILOR', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-05-19 00:00:00', null, null);
INSERT INTO servicios VALUES ('222', 'Alquiler Cama Balinesa', 'BALI', '3', '', '', '', '', '', '', '2', null, null, null, null, '7', '2014-05-19 00:00:00', null, null);
INSERT INTO servicios VALUES ('223', 'Alquiler Bicicletas', 'BICIS', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-06-25 00:00:00', null, null);
INSERT INTO servicios VALUES ('224', 'Descuento publicidad ', 'Publi', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-07-04 00:00:00', null, null);
INSERT INTO servicios VALUES ('225', 'Day Use', 'DAYUS', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-08-01 00:00:00', null, null);
INSERT INTO servicios VALUES ('226', 'Alquiler Babyphone', 'BPHON', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2014-09-05 00:00:00', null, null);
INSERT INTO servicios VALUES ('227', 'Muñeco Be Chachi', 'CHACH', '3', '', '', '', '', '', '', '2', null, null, null, null, '7', '2014-11-10 00:00:00', null, null);
INSERT INTO servicios VALUES ('228', 'Puzzle Chachi (formula Creativa)', 'CHACH', '3', '', '', '', '', '', '', '2', null, null, null, null, '37', '2014-09-15 00:00:00', null, null);
INSERT INTO servicios VALUES ('229', 'Bolsa Chachi', 'CHACH', '3', '', '', '', '', '', '', '2', null, null, null, null, '37', '2014-09-15 00:00:00', null, null);
INSERT INTO servicios VALUES ('230', 'Libro El Secreto de los Chachis', 'CHACH', '3', '', '', '', '', '', '', '2', null, null, null, null, '37', '2014-09-15 00:00:00', null, null);
INSERT INTO servicios VALUES ('231', 'Libro de los dibujos Chachis', 'CHACH', '3', '', '', '', '', '', '', '2', null, null, null, null, '37', '2014-09-15 00:00:00', null, null);
INSERT INTO servicios VALUES ('232', 'Libro actividades Chachis', 'CHACH', '3', '', '', '', '', '', '', '2', null, null, null, null, '37', '2014-09-15 00:00:00', null, null);
INSERT INTO servicios VALUES ('233', 'Disco CD Chachi', 'CHACH', '3', '', '', '', '', '', '', '2', null, null, null, null, '37', '2014-09-15 00:00:00', null, null);
INSERT INTO servicios VALUES ('234', 'Super-pack Chachi', 'CHACH', '3', '', '', '', '', '', '', '2', null, null, null, null, '37', '2014-09-15 00:00:00', null, null);
INSERT INTO servicios VALUES ('235', 'Cambio HAB misma Categoría', 'HAB=', '1', '', '', '', '', '', '', '1', null, '30.00', null, null, '37', '2015-02-20 00:00:00', null, null);
INSERT INTO servicios VALUES ('236', 'Camisetas Animación', 'CAMIS', '3', '', '', '', '', '', '', '2', null, '10.00', null, null, '37', '2015-03-27 00:00:00', null, null);
INSERT INTO servicios VALUES ('237', 'Descuento Habitación', 'DESH', '1', '', '', '', '', '', '', '1', null, null, null, null, '37', '2015-06-11 00:00:00', null, null);
INSERT INTO servicios VALUES ('238', 'Sorteos de animación', 'SORTE', '3', '', '', '', '', '', '', '1', null, null, null, null, '7', '2015-08-25 00:00:00', null, null);
INSERT INTO servicios VALUES ('239', 'Comisión venta Sun Care', 'SUNCA', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2015-09-14 00:00:00', null, null);
INSERT INTO servicios VALUES ('240', 'Alojamiento Villas', 'AVILL', '1', '', '', '', '', '', '', '2', '99', null, null, null, '2', '2015-09-14 00:00:00', '3', null);
INSERT INTO servicios VALUES ('241', 'Villas', 'VILL', '1', '', '', '', '', '', '', '1', '1', null, null, null, '2', '2015-09-14 00:00:00', '3', null);
INSERT INTO servicios VALUES ('242', 'Taza Chachi', 'TAZA', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2015-11-09 00:00:00', null, null);
INSERT INTO servicios VALUES ('243', 'Descuento publicidad suplemento VIP', 'DTVIP', '3', '', '', '', '', '', '', '1', '2', null, null, null, '7', '2015-11-25 00:00:00', null, null);
INSERT INTO servicios VALUES ('244', 'Muñeco Be Chachi grande', 'CHACH', '1', '', '', '', '', '', '', '1', null, null, null, null, '7', '2015-11-26 00:00:00', null, null);
...
CREATE SEQUENCE tipos_condicion_seq;

CREATE TABLE tipos_condicion (
  tipo_condicion_id smallint NOT NULL DEFAULT NEXTVAL ('tipos_condicion_seq'),
  condicion varchar(2) NOT NULL,
  literal varchar(15) DEFAULT NULL,
  PRIMARY KEY (tipo_condicion_id)
)  ;

ALTER SEQUENCE tipos_condicion_seq RESTART WITH 7;
...
CREATE SEQUENCE tipos_de_imputacion_seq;

CREATE TABLE tipos_de_imputacion (
  tipo_imputacion_id smallint NOT NULL DEFAULT NEXTVAL ('tipos_de_imputacion_seq'),
  imputacion varchar(20) NOT NULL,
  PRIMARY KEY (tipo_imputacion_id)
)  ;

ALTER SEQUENCE tipos_de_imputacion_seq RESTART WITH 5;
...
CREATE TABLE tipos_de_oferta (
  tipo_oferta_id smallint NOT NULL,
  Oferta varchar(25) NOT NULL,
  permitir_m_mayor_que_n smallint NOT NULL DEFAULT '1',
  rejilla smallint NOT NULL DEFAULT '0',
...
CREATE SEQUENCE tipos_de_tarjeta_seq;

CREATE TABLE tipos_de_tarjeta (
  tipo_tarjeta_id smallint NOT NULL DEFAULT NEXTVAL ('tipos_de_tarjeta_seq'),
  tipo_tarjeta varchar(15) DEFAULT NULL,
  tarjeta_length varchar(20) DEFAULT NULL,
  tarjeta_prefixes varchar(40) DEFAULT NULL,
  tarjeta_checkdigit smallint DEFAULT NULL,
  PRIMARY KEY (tipo_tarjeta_id)
)  ;

ALTER SEQUENCE tipos_de_tarjeta_seq RESTART WITH 3;
...
CREATE SEQUENCE tipos_habitacion_seq;

CREATE TABLE tipos_habitacion (
  tipo_habitacion_id smallint NOT NULL DEFAULT NEXTVAL ('tipos_habitacion_seq'),
  desc_corta varchar(6) NOT NULL,
  descripcion varchar(50) NOT NULL,
  grupo_habitacion_id smallint DEFAULT NULL,
  numero_personas smallint NOT NULL,
  desvios smallint DEFAULT NULL,
  no_show smallint DEFAULT '0',
...
ALTER SEQUENCE tipos_habitacion_seq RESTART WITH 25;
...
CREATE SEQUENCE tipos_hotel_seq;

CREATE TABLE tipos_hotel (
  tipo_hotel_id smallint NOT NULL DEFAULT NEXTVAL ('tipos_hotel_seq'),
  tipo_hotel varchar(30) DEFAULT NULL,
  abreviatura varchar(6) DEFAULT NULL,
  PRIMARY KEY (tipo_hotel_id)
)  ;

ALTER SEQUENCE tipos_hotel_seq RESTART WITH 5;
...
CREATE SEQUENCE tipos_huesped_seq;

CREATE TABLE tipos_huesped (
  tipo_huesped_id smallint NOT NULL DEFAULT NEXTVAL ('tipos_huesped_seq'),
  descripcion varchar(30) NOT NULL,
  Desc_corta varchar(2) NOT NULL,
  uc_id smallint DEFAULT NULL,
...
ALTER SEQUENCE tipos_huesped_seq RESTART WITH 5;
...
CREATE TABLE tipos_pension (
  tipo_pension_id smallint NOT NULL,
...
CREATE SEQUENCE tipos_servicio_seq;

CREATE TABLE tipos_servicio (
  tipo_servicio_id smallint NOT NULL DEFAULT NEXTVAL ('tipos_servicio_seq'),
  nombre_tipo_servicio varchar(30) NOT NULL,
  PRIMARY KEY (tipo_servicio_id)
)  ;

ALTER SEQUENCE tipos_servicio_seq RESTART WITH 8;
...
CREATE SEQUENCE tipos_unidad_calculo_seq;

CREATE TABLE tipos_unidad_calculo (
  tipo_unidad_calculo_id smallint NOT NULL DEFAULT NEXTVAL ('tipos_unidad_calculo_seq'),
  tipo_uc varchar(15) NOT NULL,
  PRIMARY KEY (tipo_unidad_calculo_id)
)  ;

ALTER SEQUENCE tipos_unidad_calculo_seq RESTART WITH 3;
...
CREATE SEQUENCE unidades_calculo_seq;

CREATE TABLE unidades_calculo (
  unidad_calculo_id smallint NOT NULL DEFAULT NEXTVAL ('unidades_calculo_seq') ,
  UC varchar(4) NOT NULL,
  descripcion_unidad_calculo varchar(30) NOT NULL,
  tipo_unidad_calculo_id smallint DEFAULT NULL,
  pax boolean(4) DEFAULT NULL,
  servicio_id int DEFAULT NULL,
  user_id int DEFAULT NULL,
  fecha_modificacion timestamp(0) DEFAULT NULL,
...
ALTER SEQUENCE unidades_calculo_seq RESTART WITH 7;
...
-- ----------------------------
INSERT INTO unidades_calculo VALUES ('1', 'SRV', 'Servicio', '1', '', null, '2', null);
...
INSERT INTO unidades_calculo VALUES ('5', 'B', 'Bebes', '2', '', '7', '2', null);
INSERT INTO unidades_calculo VALUES ('6', 'A+N', 'A+N1+N2+B', '2', '', null, '2', null);
