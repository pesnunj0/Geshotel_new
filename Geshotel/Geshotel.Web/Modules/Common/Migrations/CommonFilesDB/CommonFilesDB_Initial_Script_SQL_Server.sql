...
CREATE TABLE categoria_hoteles (
  [categoria_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE comunidades_autonomas (
  [comunidad_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE conceptos_acelerador_reservas (
  [concepto_acelerador_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE empresas (
  [empresa_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE formas_de_pago (
  [forma_pago_id] smallint NOT NULL IDENTITY,
  [forma_pago] varchar(20) NOT NULL,
  [credito] binary(1) NOT NULL DEFAULT b'0',
  [sw_efectivo] binary(1) DEFAULT NULL,
  [sw_tarjeta] binary(1) DEFAULT NULL,
  [tarjeta_length] varchar(20) DEFAULT NULL,
  [tarjeta_prefixes] varchar(40) DEFAULT NULL,
  [tarjeta_checkdigit] binary(1) DEFAULT NULL,
  [sw_dingus] binary(1) DEFAULT b'0',
  [produccion_tpv] binary(1) DEFAULT b'1',
...
CREATE TABLE frecuencia_facturacion (
  [frecuencia_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE grupos_de_cliente (
  [grupo_cliente_id] smallint NOT NULL IDENTITY,
  [nombre_grupo] varchar(30) NOT NULL,
  [huesped] binary(1) NOT NULL DEFAULT b'0',
  [contratos] binary(1) NOT NULL DEFAULT b'0',
  [facturar] binary(1) NOT NULL DEFAULT b'1',
  [agencia] binary(1) NOT NULL DEFAULT b'0',
...
CREATE TABLE grupos_de_servicios (
  [grupo_servicio_id] int NOT NULL IDENTITY,
...
CREATE TABLE grupos_oferta (
  [grupo_oferta_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE hoteles (
  [hotel_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE impuestos (
  [impuesto_id] smallint NOT NULL IDENTITY,
  [empresa_id] smallint NOT NULL,
  ...
  [fecha_actualizacion] datetime2(0) DEFAULT NULL,
...
CREATE TABLE monedas (
  [moneda_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE naciones (
  [nacion_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE provincias (
  [provincia_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE servicios (
  ...
  [sw_produccion] binary(1) NOT NULL DEFAULT b'1',
  [sw_descuento] binary(1) DEFAULT b'0',
  [sw_ajustes] binary(1) DEFAULT b'0',
  [sw_gastos] binary(1) DEFAULT b'0',
  [sw_pension] binary(1) NOT NULL DEFAULT b'0',
  [sw_rectificativa] binary(1) DEFAULT b'0',
...
CREATE TABLE tipos_condicion (
  [tipo_condicion_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE tipos_de_imputacion (
  [tipo_imputacion_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE tipos_de_tarjeta (
  [tipo_tarjeta_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE tipos_habitacion (
  [tipo_habitacion_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE tipos_hotel (
  [tipo_hotel_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE tipos_huesped (
  [tipo_huesped_id] smallint NOT NULL IDENTITY,
  [descripcion] varchar(30) NOT NULL,
...
CREATE TABLE tipos_servicio (
  [tipo_servicio_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE tipos_unidad_calculo (
  [tipo_unidad_calculo_id] smallint NOT NULL IDENTITY,
...
CREATE TABLE unidades_calculo (
  [unidad_calculo_id] smallint NOT NULL IDENTITY ,
  [UC] varchar(4) NOT NULL,
  [descripcion_unidad_calculo] varchar(30) NOT NULL,
  [tipo_unidad_calculo_id] smallint DEFAULT NULL,
  [pax] binary(1) DEFAULT NULL,
  [servicio_id] int DEFAULT NULL,
  [user_id] int DEFAULT NULL,
  [fecha_modificacion] datetime2(0) DEFAULT NULL,
