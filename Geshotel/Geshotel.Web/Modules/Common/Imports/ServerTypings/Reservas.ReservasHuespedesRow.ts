...
namespace Geshotel.Reservas {
    ...
    export namespace ReservasHuespedesRow {
        ...
        export const localTextPrefix = 'Reservas.ReservasHuespedes';

        export namespace Fields {
            export declare const ReservasHuespedesId;
            export declare const ReservaId;
            export declare const ClienteId;
            export declare const FechaLlegada;
            export declare const FechaSalida;
