...
namespace Geshotel.Recepcion {
    export namespace ReservasService {
        ...
        export declare function ReservationCheckIn(request: Serenity.SaveRequest<ReservasRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        ...
        export namespace Methods {
            ...
            export declare const ReservationCheckIn: string;
        }

        ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'ReservationCheckIn'].forEach(x => {
