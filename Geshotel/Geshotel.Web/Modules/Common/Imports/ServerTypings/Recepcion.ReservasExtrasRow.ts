...
namespace Geshotel.Recepcion {
    export interface ReservasExtrasRow {
    ...
    export namespace ReservasExtrasRow {
        ...
        export namespace Fields {
            ...
            export declare const ReservaTipoHabitacionId: string;
            export declare const ReservaVip: string;
            export declare const ReservaPensionId: string;
            export declare const ReservaAdultos: string;
            export declare const ReservaChild50: string;
            export declare const ReservaChildFree: string;
            export declare const ReservaBebes: string;
