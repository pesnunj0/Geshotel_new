...
namespace Geshotel.Reservas {
    ...
    export namespace ReservasDescuentosRow {
        ...
        export const localTextPrefix = 'Reservas.ReservasDescuentos';

        export namespace Fields {
            export declare const ReservaDescuentoId;
            export declare const ReservaId;
            export declare const ServicioId;
            export declare const TipoDescuentoId;
            export declare const Tipo;
            export declare const Descuento;
