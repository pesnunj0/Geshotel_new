...
namespace Geshotel.Contratos.Entities
{
    ...
    public sealed class CuposRow : Row, IIdRow
    {
        ...
        [DisplayName("Tipo Habitacion"), Column("tipo_habitacion_id"), NotNull, ForeignKey("[dbo].[tipos_habitacion]", "tipo_habitacion_id"), LeftJoin("jTipoHabitacion"), TextualField("TipoHabitacionDescCorta")]
