...
namespace Geshotel.Portal.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("usuarios_empresa"), InstanceName("usuarios_empresa"), TwoLevelCached]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
 //   [LookupScript("Portal.UsuariosEmpresa")]
    public sealed class UsuariosEmpresaRow : Row, IIdRow
    {
        [DisplayName("User"), PrimaryKey, ForeignKey("users", "UserId"), LeftJoin("jUser"), TextualField("UserUsername")]
        public Int32? UserId
        {
        ...
        [DisplayName("Empresa"), Column("empresa_id"), PrimaryKey, ForeignKey("empresas", "empresa_id"), LeftJoin("jEmpresa")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowFields()
                : base("usuarios_empresa")
            {
                LocalTextPrefix = "Portal.UsuariosEmpresa";
            }
        }
    }
}
